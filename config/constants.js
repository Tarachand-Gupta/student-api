...
module.exports.AWS_ERROR_MESSAGE = `Sorry server is not responding.`;
...
module.exports.USER_POST_OK = `Post uploaded successful.`;
module.exports.USER_POST_FAILED = `Post uploaded unsuccessful.`;
